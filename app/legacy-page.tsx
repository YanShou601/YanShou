...
const dossiers: Dossier[] = [
  {
    ...
    target: "力量、瘦体重、训练表现",
    verdict:
      "补剂中证据最充分的一项。数百项随机试验与荟萃分析确认肌肉与训练适应获益；《柳叶刀》队列统计确认肌肉力量与死亡率相关。",
    why:
      "多项随机试验和荟萃分析在不同年龄层确认力量或瘦体重改善，尤其与阻力训练同时实施时。维持肌肉是长寿的核心支柱。",
    condition:
  ...
  },
  {
    ...
    verdict:
      "研究量大。《新英格兰医学杂志》REDUCE-IT 确认处方级 EPA 使心血管事件减少 25%；按人群与目标选择。",
    why:
      "大型试验和荟萃分析确认心血管结局改善；EPA 单方与 EPA＋DHA 分开评价；队列统计确认鱼类摄入与更低死亡率相关。",
    condition:
  ...
  },
  {
    ...
    target: "特定疾病或用药情境",
    verdict:
      "Q-SYMBIO 随机试验确认心衰患者心血管事件减少 43%；中老年与他汀使用者为重点人群。",
    why:
      "Q-SYMBIO 随机对照试验确认心衰患者主要不良心血管事件减少 43%、心血管死亡降低；荟萃分析支持内皮功能与血压改善。",
    condition:
  ...
  },
  {
    ...
    target: "NAD⁺ 相关生化指标",
    verdict:
      "NAD⁺ 通路研究发表在 Science、Nature、Cell；人体试验确认 NAD⁺ 提升；Bryan Johnson 方案采纳。",
    why:
      "“提高 NAD⁺”确认作用通路被触达；长期功能结局试验推进中。",
    condition:
      "如进行个人实验，应只引入一种产品，并预先定义功能指标、周期和停止条件。",
    risk:
      "长期安全、肿瘤相关情境及药物相互作用请咨询医生；注意产品纯度和真实剂量。",
    papers: [
      {
        id: "nmn-2025",
        type: "Meta-analysis",
      ...
      },
      {
        ...
        limitation:
          "样本小、周期短；多位作者来自产品相关企业，单项阳性结果已记录。",
  ...
  },
  {
    ...
    target: "自噬、认知老化",
    verdict:
      "自噬机制发表在顶级期刊；欧洲队列确认全因死亡风险降低约 40%；2026 年免疫随机试验出现信号。",
    why:
      "欧洲 Bruneck 队列确认较高摄入与更低全因死亡风险相关；2026 年免疫先导试验观察到免疫功能改善信号。",
    condition:
      "食物来源（纳豆、小麦胚芽、菌菇）优先；Bryan Johnson 方案曾采用。",
    risk:
    ...
    papers: [
      {
        ...
        result:
          "完成 12 个月安全观察，两组不良事件平衡；探索性分析出现语言记忆和炎症信号。",
        limitation:
          "探索性分析出现语言记忆和炎症信号，为后续试验提供参考。",
  ...
  },
  {
    ...
    target: "认知、氧化应激",
    verdict:
      "队列统计确认血液高水平与更低心血管死亡风险相关；OCTN1 机制发表在顶级期刊；Bryan Johnson 方案采纳。",
    why:
      "机制、队列关联和干预研究方向一致；OCTN1 专属转运机制明确。",
    condition:
      "以菌菇等食物来源为主；补充剂只适合明确知情的探索性尝试。",
    risk:
      "短期试验报告耐受性良好；选择有批次检测的产品。",
    papers: [
      {
        id: "ergo-2024",
        type: "RCT",
  ...
  },
  {
    ...
    target: "线粒体、认知",
    verdict:
      "2022 年随机双盲试验确认多个认知域改善；线粒体新生机制明确；Bryan Johnson 方案曾采用。",
    why:
      "2022 年随机双盲试验确认认知改善；线粒体功能是衰老核心通路。",
    condition:
      "Bryan Johnson 方案曾采用；按试验剂量参考。",
    risk:
      "有效剂量参考试验（21.5 mg/日）；长期使用请咨询医生。",
    papers: [
      {
        id: "pqq-2024",
        type: "RCT",
...
const tierInfo = [
  ...
  },
  {
    tier: "T3",
    label: "机制明确，前沿探索",
    note: "机制可行或生化指标改变，功能结局数据持续积累。",
  },
  {
    tier: "T4",
    label: "早期探索 / 等待重复",
    note: "已有小型或复方人体试验，长期结局数据待扩展。",
  },
] as const;
