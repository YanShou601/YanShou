...
- `NCT04691986`：NR 对老年退伍军人的功能与肌肉生理；截至本次快照为 `ACTIVE_NOT_RECRUITING`，尚无结果记录；
...
| PQQ | 58 人完成的单方认知 RCT 报告多项阳性结果，但样本小、结局多且产品相关；复方试验不可归因 | 不能确认线粒体功能、长期认知或健康寿命获益 |
| Ca-AKG | 人体资料以无对照复方前后比较、横断面关联和甲基化时钟为主；关键 RCT 尚无结果 | 不能把“生物年龄”变化等同于实际变年轻或延寿 |
...
- 对长期安全、药物相互作用、肿瘤情境、妊娠哺乳和复杂疾病资料不足的部分，统一标为未知。
